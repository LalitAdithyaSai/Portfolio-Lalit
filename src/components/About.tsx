...
const About = () => {
  const education = [
    ...
    },
    {
      ...
      grade: "Marks 640/1000",
      icon: Award,
    },
    {
      degree: "School (2019)",
      field: "State Secondary Education",
      institution: "Bhashyam Blooms High School",
      grade: "GPA 9.3",
      icon: BookOpen,
    },
  ];
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              Passionate about technology and to expand my knowledge in the field of Information
              Technology. I am seeking a challenging opportunity that allows me to enhance my technical skills while also

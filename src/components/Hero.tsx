      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        <div className="mb-8 animate-fade-in">
          <div className="relative inline-block animate-float">
            <img
              src={profilePicture}
              alt="Kokkirala Lalit Adithya Sai"
        ...
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6 animate-slide-up">
          <span className="gradient-text">Kokkirala Lalit Adithya Sai</span>
        </h1>
        ...
        <p className="text-lg sm:text-xl text-muted-foreground max-w-3xl mx-auto mb-12 leading-relaxed animate-slide-up" style={{ animationDelay: '0.4s' }}>
          Aspiring engineering student eager to apply Python, Web Framework, and Web Development skills in real-world projects.
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-slide-up" style={{ animationDelay: '0.6s' }}>
          ...
          <Button variant="outline" size="lg" onClick={handleDownloadResume} className="w-full sm:w-auto" asChild>
            <a href='https://drive.google.com/file/d/1Uk3YrdwvrZ70hvD-ftEfehf5IDyYXFJd/view?usp=drive_link' target='_blank' rel="noopener noreferrer">

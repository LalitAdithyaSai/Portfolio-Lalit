...
const Contact = () => {
  const socialLinks = [
    {
      name: "GitHub",
      url: "https://github.com/LalitAdithyaSai",
      icon: Github,
      username: "@LalitAdithyaSai",
      description: "Check out my code repositories and project contributions",
      color: "hover:text-gray-900 dark:hover:text-gray-100"
    },
    {
      name: "LinkedIn", 
      url: "https://www.linkedin.com/in/kokkiralalalitadithyasai/",
      icon: Linkedin,
      username: "Kokkirala Lalit Adithya Sai",
      description: "Connect with me professionally",
      color: "hover:text-blue-600"
    },
    {
      name: "Instagram",
      url: "https://www.instagram.com/lalit_adithya_sai",
      icon: Instagram,
      username: "@lalit_adithya_sai",
      description: "Follow my journey and daily updates",
      color: "hover:text-pink-600"
    },
    {
      name: "HackerRank",
      url: "https://www.hackerrank.com/profile/lalitadithyasai",
      icon: Award,
      username: "lalitadithyasai",
    ...
    {
      name: "WhatsApp",
      url: "https://wa.me/917731913181",
      icon: MessageCircle,
      username: "+91 7731913181",
  ...
  const contactInfo = [
    {
      icon: Mail,
      label: "Email",
      value: "lalitadithyasai@gmail.com",
      href: "mailto:lalitadithyasai@gmail.com"
    },
    {
      icon: Phone,
      label: "Phone",
      value: "+91 7731913181",
      href: "tel:+917731913181"
    },
    {
      icon: MapPin,
      label: "Location",
      value: "Madhapur, India",
      href: "https://maps.app.goo.gl/Kno56NNMzzP7jF8R8?g_st=iw"
    }
  ];
      ...
      <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            >
              <Card className="p-6 bg-gradient-card border-primary/10">
                ...
                <a href='mailto:lalitadithyasai@gmail.com'>
              ...
              <Card className="p-6 bg-gradient-hero text-white border-0 shadow-glow">
                ...
                <div className="flex gap-3">
                  <Button variant="secondary" size="sm" asChild>
                    <a href="https://github.com/LalitAdithyaSai" target="_blank" rel="noopener noreferrer">
                      <Github className="w-4 h-4 mr-2" />
                      GitHub
                    </a>
                  </Button>
                  <Button variant="outline" size="sm" className="bg-white/10 border-white/30 text-white hover:bg-white/20" asChild>
                    <a href="https://www.linkedin.com/in/kokkiralalalitadithyasai/" target="_blank" rel="noopener noreferrer">
        ...
        >
          <p className="text-muted-foreground">
            © 2024 Kokkirala Lalit Adithya Sai.
          </p>
        </motion.div>
      </div>
    </section>
